...
<html lang="en">
    <head>
        ...
        <script nonce="ed506b5a-f165-4949-8a2a-c4c15ede5c03">
            (function (w, d) {
                !(function (bg, bh, bi, bj) {
                    ...
                    for (const bm of ["track", "set", "debug"])
                        bg.zaraz[bm] = bg.zaraz._f(bm);
                    bg.zaraz.init = () => {
                        ...
                        bp &&
                            (bg[bi].t =
                                bh.getElementsByTagName("title")[0].text);
                        bg[bi].x = Math.random();
                        ...
                        if (bg.dataLayer)
                            for (const bt of Object.entries(
                                ...
                                zaraz.set(bt[0], bt[1], { scope: "page" });
                        bg[bi].q = [];
                        ...
                        bo.defer = !0;
                        for (const bx of [localStorage, sessionStorage])
                            Object.keys(bx || {})
                                .filter((bz) => bz.startsWith("_zaraz_"))
                                .forEach((by) => {
                                    try {
                                        bg[bi]["z_" + by.slice(7)] = JSON.parse(
                                            bx.getItem(by)
                                        );
                                    } catch {
                                        bg[bi]["z_" + by.slice(7)] =
                        ...
                        bo.src =
                            ...
                            btoa(encodeURIComponent(JSON.stringify(bg[bi])));
                        bn.parentNode.insertBefore(bo, bn);
                    };
                    ["complete", "interactive"].includes(bh.readyState)
                        ? zaraz.init()
                        : bg.addEventListener("DOMContentLoaded", zaraz.init);
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <a href="" class="brand-link">
                    <img
                        ...
                        style="opacity: 0.8"
                    />
                    <span class="brand-text font-weight-light">Xarala</span>
                </a>
                ...
                <div class="sidebar">
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img
                                src="{{asset('img/pa.jpg')}}"
                                class="img-circle elevation-2"
                                alt="User Image"
                            />
                        </div>
                        <div class="info">
                            <a href="#" class="d-block">Elhadji Samba SY</a>
                        </div>
                    </div>
            ...
            <footer class="main-footer">
                <strong
                    ...
                    <a href="https://adminlte.io">Elhadji Samba Sy</a>.</strong
                >
                All rights reserved.
